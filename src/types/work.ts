...
export const AGE_RATING_DESCRIPTION: Record<AgeRating, string> = {
    all: "どなたでも読めます。",
    /*
     * ★ R15 は「勧める目安」であって、禁止ではない。
     *
     *   R18 のような明確な決まりが無く、
     *   ほかの投稿サイトでも 15 歳以上に勧める形にしている。
     *   ログインしていなくても読める。
     */
    r15: "15歳以上の方に勧めます。暴力・性的な示唆を含みます。ログインは要りません。",
    r18: "18歳以上向け。成人向けの描写を含みます。読むには生年月日の登録が要ります。",
};
