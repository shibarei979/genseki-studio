...
const faqCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'AIを使ってもいいですか？', a: '文章については、誤字脱字修正・表現の言い換え・文法校正・アイデア出しなど補助的な利用は可能です。ただし、AI生成文章をそのまま投稿することや、作品の大部分をAIに依存することは禁止です。表紙や挿絵にAIで作った画像を使うことはできますが、作品の設定で「この表紙は AI を使って作りました」を選んでください。表紙に印が出ます。' },
    ]
  },
  {
