...
export default function HomeSelectPage() {
  ...
  return (
    <div style={{
      ...
      {/* 背景装飾 */}
      <div className="bg-blob" style={{ width: 460, height: 460, background: 'rgba(31,78,107,0.10)', top: '-140px', left: '-120px' }}/>
      <div className="bg-blob" style={{ width: 400, height: 400, background: 'rgba(61,159,212,0.10)', bottom: '-130px', right: '-110px' }}/>
      <div className="bg-blob" style={{ width: 300, height: 300, background: 'rgba(120,180,220,0.08)', top: '18%', right: '12%' }}/>
      <div className="bg-dot" style={{ width: 10, height: 10, background: 'rgba(31,78,107,0.28)', top: '16%', left: '18%', animation: 'floaty 6s ease-in-out infinite' }}/>
      <div className="bg-dot" style={{ width: 7, height: 7, background: 'rgba(61,159,212,0.30)', top: '68%', left: '24%', animation: 'floaty 7s ease-in-out infinite .8s' }}/>
      <div className="bg-dot" style={{ width: 12, height: 12, background: 'rgba(120,180,220,0.28)', top: '26%', right: '20%', animation: 'floaty 8s ease-in-out infinite .4s' }}/>
      <div className="bg-dot" style={{ width: 8, height: 8, background: 'rgba(61,159,212,0.22)', bottom: '20%', right: '26%', animation: 'floaty 6.5s ease-in-out infinite 1.2s' }}/>
        ...
        <>
          ...
          <div style={{ display: 'flex', gap: 28, alignItems: 'stretch', zIndex: 1, flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <button onClick={() => handleSelectRole('reader')} disabled={loading} className="role-card"
              style={{ width: 260, background: '#fff', border: '1px solid #cfe4f2', borderRadius: 18, overflow: 'hidden', cursor: 'pointer', padding: 0, display: 'flex', flexDirection: 'column' }}>
              <div style={{ padding: '36px 24px 28px', flex: 1 }}>
                <div style={{ width: 76, height: 76, margin: '0 auto 22px', borderRadius: '50%', border: `1.5px solid #A8D8D2`, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke={READ} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/>
                  </svg>
                </div>
                <div style={{ fontSize: 30, fontWeight: 800, color: READ, marginBottom: 10, letterSpacing: '0.06em' }}>読む人</div>
                <div style={{ fontSize: 14, color: '#666' }}>物語を楽しみたい</div>
              </div>
              <div style={{ background: READ, color: '#fff', padding: '18px 20px', fontSize: 15, fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
                読む人ではじめる
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
              </div>
            </button>
        ...
        <>
          ...
          <div style={{ display: 'flex', gap: 24, alignItems: 'stretch', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <button onClick={() => handleReaderAi(false)} disabled={loading} className="role-card"
              style={{ width: 250, background: '#fff', border: '1px solid #cfe4f2', borderRadius: 18, overflow: 'hidden', cursor: 'pointer', padding: 0, display: 'flex', flexDirection: 'column' }}>
              <div style={{ padding: '32px 22px 24px', flex: 1 }}>
                <div style={{ width: 68, height: 68, margin: '0 auto 18px', borderRadius: '50%', border: '1.5px solid #A8D8D2', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke={READ} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M20 3c-7 1-12 6-14 12l-3 6 6-3c6-2 11-7 12-14z"/><path d="M14 8c-3 2-6 5-8 9"/>
                  </svg>
                </div>
                <div style={{ fontSize: 22, fontWeight: 800, color: READ, marginBottom: 10, letterSpacing: '0.04em' }}>表示しない</div>
                <div style={{ fontSize: 13, color: '#666', lineHeight: 1.7 }}>人の手で書かれた<br/>作品だけを読みたい</div>
              </div>
              <div style={{ background: READ, color: '#fff', padding: '16px 20px', fontSize: 14.5, fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
                これではじめる
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
              </div>
            </button>
