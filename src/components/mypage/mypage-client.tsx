...
const TAB_ICONS: Record<string, React.ReactNode> = {
  ...
  /* 誤字報告。赤入れの筆 */
  typos:     <><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4z"/></>,
  ...
  /* アイテム。集めて飾るものなので、贈り物の形にする */
  items:     <><rect x="3" y="8" width="18" height="13" rx="1"/><path d="M3 12h18"/><path d="M12 8v13"/><path d="M12 8S9.5 3 7.5 4.5 8 8 12 8zM12 8s2.5-5 4.5-3.5S16 8 12 8z"/></>,
...
export default function MypageClient({
  ...
  const tabContent: Record<Tab, React.ReactNode> = {
    mypage:'', works:'', typos:'', bookmarks:'', history:'', tweet:'', mission:'', items:'', settings:'', series:'',
  }
