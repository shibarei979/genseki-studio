...
class LayoutCalc {
     ...
     * 背の厚み。
     *
     * 0.9（54px）から 1.2（72px）へ。
     * 薄いまま数だけ並ぶと、冊数のわりに詰まって見え、
     * 情報量が多く感じられた。
     *
     * ★ ここだけなら CSS を触らなくてよい。
     *   背表紙の幅は --b-depth として CSS へ渡され、
     *   自動でついてくる。
     *
     * ★ 本の横幅・高さ（B_WIDTH / B_HEIGHT）は別。
     *   bookshelf.css の 23 か所に同じ 0.9 が書かれていて、
     *   片方だけ変えると中身の位置が合わなくなる。
     */
    static B_DEPTH = 60 * 1.2;
