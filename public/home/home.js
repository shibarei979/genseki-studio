...
class LayoutCalc {
     ...
     *
     * ここは触らない。
     * 一度小さくしたが、棚の高さや位置の計算と噛み合わず、
     * 本が巨大化して左右に散らばった。
     * 大きさを変えたいときは CSS の側で縮める。
     */
    /*
     * 本の寸法。
     *
     *   WIDTH   表紙の横。真ん中の1冊で使う
     *   HEIGHT  背の高さ
     *   DEPTH   背の厚み。両脇に並ぶ本の幅になる
     *
     * 0.9 から 1.17（0.9 × 1.3）へ。
     * 本が小さく、背が薄くて、冊数のわりに詰まって見えた。
     *
     * 厚みはさらに増やす。
     * 薄いまま数だけ並ぶと、情報量が多く感じられる。
     *
     * ★ ここを変えると並びの計算も変わる。
     *   両脇の冊数（B_SIDE_COUNT）と一緒に見ること。
     *   厚みを増やすと、同じ幅に入る冊数が減る。
     */
    static B_WIDTH = 245 * 1.17;
    static B_HEIGHT = 300 * 1.17;
    static B_DEPTH = 60 * 1.4;
     ...
     * 入る冊数は画面の幅で変わる。
     *
     *   冊数 =（画面の幅 − 本の横 287 − 余白 400）÷ 2 ÷ 厚み 84
     *
     *   1920px → 7 冊
     *   2560px → 11 冊
     *
     * 多すぎると真ん中の本と重なり、
     * 少なすぎると両脇が空く。
     * 広い画面と狭い画面の間を取って 9 にしている。
     *
     * ★ 端が空く／重なるときは、この数字だけを動かす。
     */
    static B_SIDE_COUNT = 9;
